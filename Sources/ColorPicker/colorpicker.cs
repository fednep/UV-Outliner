...
namespace Microsoft.Samples.CustomControls
{
    ...
    public class ColorPicker : Control
    {
        ...
        public static RoutedCommand AddToSelected = new RoutedCommand();
        ...
        public override void OnApplyTemplate()
        {
            ...
            m_ColorDetail.MouseDown += new MouseButtonEventHandler(m_ColorDetail_MouseDown);
            m_ColorDetail.MouseUp += new MouseButtonEventHandler(m_ColorDetail_MouseUp);
        ...
        void m_ColorDetail_MouseUp(object sender, MouseButtonEventArgs e)
        {
            m_ColorDetail.ReleaseMouseCapture();
        }

        void m_ColorDetail_MouseDown(object sender, MouseButtonEventArgs e)
        {
            m_ColorDetail.CaptureMouse();
        }
        ...
        private void updateMarkerPosition(Point p)
        {
            ...
            if (p.X > m_ColorDetail.ActualWidth)
                p.X = m_ColorDetail.ActualWidth;

            if (p.Y > m_ColorDetail.ActualHeight)
                p.Y = m_ColorDetail.ActualHeight;
        ...
        private void updateMarkerPosition(Color theColor)
        {
            ...
            m_ColorSlider.Value = 360-hsv.H; /* was: hsv.H*/
        ...
        {
            /* 360 - */
            HsvColor hsv = new HsvColor(m_ColorSlider.Value, 1, 1);
            hsv.S = p.X;
            hsv.V = 1 - p.Y;
