...
namespace DragDropListBox
{
	public class InsertionAdorner : Adorner
	{
        ...
        private UIElement __AdornedElement;
			...
			: base(adornedElement)
		{
            ...
            __AdornedElement = adornedElement;
		}
		...
		protected override void OnRender(DrawingContext drawingContext)
		{
            ...
            TreeListViewItem item = __AdornedElement as TreeListViewItem;
            if (item.TopDragMargin == 0)
                return;
		...
		private void CalculateStartAndEndPoint(out Point startPoint, out Point endPoint)
		{
			...
			if (this.isSeparatorHorizontal)
			{
                ...
                if (item != null)
                {
                    startPoint.Y = item.TopDragMargin / 2;
